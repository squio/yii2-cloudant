...
/**
 * Debug Action is used by [[DebugPanel]] to perform cloudant queries using ajax.
 *
...
class DebugAction extends Action
{
    ...
    public function run($logId, $tag)
    {
        ...
        switch ($method) {
            ...
            default:
                throw new NotSupportedException("Request method '$method' is not supported by cloudant.");
        }
